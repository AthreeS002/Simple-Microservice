...
public class GateController {
    ...
    public ResponseEntity<ResultDto> convert(@RequestBody TransferDto transferDto) {
        ...
        if("Celcius".equalsIgnoreCase(transferDto.getFrom()) || "Fahrenheit".equalsIgnoreCase(transferDto.getFrom()) || "Kelvin".equalsIgnoreCase(transferDto.getFrom()) || "Reamur".equalsIgnoreCase(transferDto.getFrom())) {
